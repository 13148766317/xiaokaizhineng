...
- (void)initDefaultConfign{
    ...
    _contentNorColor = KDSRGBColor(143, 146, 166);
    _contentSelColor = KDSRGBColor(68, 72, 107);
    _norColor = CBColor(255, 255, 255);
    _selColor = CBColor(248, 248, 248);
...
- (CGRect)setSignView:(NSArray *)dataAr andTitle:(NSString *)titleStr andFrame:(CGRect)frame andGroupId:(NSInteger)groupId{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(15, frame.size.height + frame.origin.y + 10, 0, 0)];
